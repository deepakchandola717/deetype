...
import DtTitle from '../data/dt-title.svg';
import EnterBackground from '../data/enter-background.svg';

const Home = () => {

    const buttonStyle={width:'16rem', padding:'0.5vw', margin:'0.4vw',zIndex:'2', backgroundColor:'white', borderRadius:'0.5rem', color:'#1A5261', cursor:'pointer'};
                ...
                <img style={{position:'absolute', zIndex:'0', bottom:'10.0vh', right:'0', height:'40vh', overflow:''}} src={EnterBackground} alt="deeType"/>
                    ...
                    <div style={{display:'flex', width:'90vw',padding:'3rem 0', margin:'auto', justifyContent:'space-around'}}>
                        <div style={{display:'flex', flexDirection:'column'}}>
                            ...
                            <div style={buttonStyle}>copy-paste text</div>
